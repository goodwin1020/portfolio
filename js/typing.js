...
//타이핑할 문장
var result123  = "간단타이핑 테스트 문장";
var typeing1=[];
result123 = result123.split(''); // 한글자씩자름

//각글자 초성,중성,종성으로 나눔
for(var i =0; i<result123.length; i++){
    typeing1[i]=result123[i].toKorChars();
}

//출력할 엘리먼트요소 가져옴 
var resultDiv = document.getElementsByClassName("result123")[0];
